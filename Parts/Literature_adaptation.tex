...
I will start this section with a definition of adaptation (although there are different possible definitions of adaptation; \citealp{endler1986natural}) and natural selection. Then I will introduce some of the methods that are used to estimate adaptation, with a focus on molecular methods.

\subsubsection{Adaptation}

Usually adaptation can refer to two different things, to an adaptive trait or to the process to become adapted \citep{endler1986natural}.
