...
%Also, I used a modified version of the Transcriptome Age Index (TAI; \citealp{Domazet-Loso2010}) and applied it to the polar regions and STs (see III, methods; Fig. \ref{fig:Art-III-TAI}). TAI is low for regions expressing old genes and large for regions expressing young genes.
%results TAI
...
%
%
% I used a modified version of the Transcriptome Age Index (TAI; \citealp{Domazet-Loso2010}) and applied it to the polar regions and STs (see III, methods; Fig. \ref{fig:Art-III-TAI}). TAI is low for regions expressing old genes and large for regions expressing young genes.
