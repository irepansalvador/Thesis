...
In contrast with Frise et al., the objective in here is not to create a fatemap in the early embryo, but to quantitatively characterize the overall spatio-temporal dynamics of development and differentiation through the entire embryonic development (as mirrored in the spatio-temporal gene expression).
