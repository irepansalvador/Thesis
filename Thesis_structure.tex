...
\usepackage{titlesec}
\titleformat{\chapter}[block] {\selectfont\huge\bfseries}{\thechapter}{1em}{\huge}
\titleformat{\section}[block] {\selectfont\Large\bfseries}{\thesection}{1em}{\Large}
\titleformat{\subsection}[block] {\selectfont\large\bfseries}{\thesubsection}{1em}{\large}
...
\reportno{86/2016}
\isbnpaperback{978-951-51-2744-0}
\isbnpdf{978-951-51-2745-7}
\issn{2342-3161}
\issnonline{2342-317X}
...
\preexaminera{Gregor Bucher, Georg-August-University G{\"o}ttingen, Germany}
\preexaminerb{Pavel Tomancak, Max Planck Institute of Molecular Cell Biology and \par
...
\custos{Juha Partanen, University of Helsinki, Finland}
...
\permissionnotice{
  ...
  Sciences of the University of Helsinki, for public examination 
  in Walter Hall (Ee-building, Agnes Sj\"{o}berg 2, Helsinki), 	\\
  on 12 December 2016, at 12 noon.
}
...
\input{./Parts/Review_start.tex}

\subsection*{What is development?}
	\input{./Parts/Development_definition.tex}
...
%	\input{./Parts/Statistical_approach.tex}
%	\clearpage 	
\section{Complexity}
	\input{./Parts/Literature_complexity.tex}
%	\clearpage 
\section{Adaptation}
	\input{./Parts/Literature_adaptation.tex}
%	\clearpage
...
\section{The Hourglass model in \textit{Drosophila} }
	\input{./Parts/Literature_hourglass.tex}
%	\clearpage
...
\chapter{Material and Methods}
	...
	\input{./Parts/Methods_complexity_measures.tex}

	\section{Data mining and handling}
	\input{./Parts/Methods_data.tex}

	\section{Estimating adaptation with DFE-alpha}
	\input{./Parts/Methods_adaptation.tex}

	\section{Transcriptome age and genomic determinants}
	\input{./Parts/Methods_TAI_determinants.tex}
...
%	\input{./Parts/Results_Art_I.tex}
%	\clearpage
%\section{Complexity and compartmentalization in \textit{Ciona}}
%	\input{./Parts/Results_Art_II.tex}
%	\clearpage
